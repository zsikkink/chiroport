...
alter table public.queue_daily_stats
  add column if not exists service_arrivals jsonb null,
  add column if not exists service_completed jsonb null,
  add column if not exists service_cancelled jsonb null,
  add column if not exists service_wait_total_minutes jsonb null,
  add column if not exists service_wait_count jsonb null,
  add column if not exists service_time_in_system_total_minutes jsonb null,
  add column if not exists service_time_in_system_count jsonb null,
  add column if not exists service_service_total_minutes jsonb null,
  add column if not exists service_service_count jsonb null;

alter table public.queue_monthly_stats
  add column if not exists service_arrivals jsonb null,
  add column if not exists service_completed jsonb null,
  add column if not exists service_cancelled jsonb null,
  add column if not exists service_wait_total_minutes jsonb null,

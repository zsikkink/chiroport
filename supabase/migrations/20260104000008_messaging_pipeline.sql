...
create unique index if not exists uniq_sms_outbox_entry_message_type
  on public.sms_outbox (queue_entry_id, message_type);

create index if not exists idx_sms_outbox_status_created_at
